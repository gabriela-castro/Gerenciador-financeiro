...
<TITLE>Boleto <?php echo remover_acentos($dadosboleto["identificacao"]); ?></TITLE>
...
<li>Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet banking:</li><br>
<span class="ld2">
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG SRC="../img/logo.png" style="max-width:150px;"></td>
