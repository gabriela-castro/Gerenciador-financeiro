<?php // +----------------------------------------------------------------------+
    ...
    <HTML>
        ...
        <HEAD>
            ...
            />
            <style type=text/css>
                <!--.cp { font: bold 10px Arial; color: black} <!--.ti { font: 9px Arial,
                Helvetica, sans-serif} <!--.ld { font: bold 15px Arial; color: #000000}
                <!--.ct { FONT: 9px "Arial Narrow"; COLOR: #000033} <!--.cn { FONT: 9px
                Arial; COLOR: black } <!--.bc { font: bold 20px Arial; color: #000000 }
        ...
        <BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
                ...
                <TR>
                    <TD valign=top class=cp>
                        <DIV ALIGN="left">
                            <p>
                                <li>
                                    Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal
                                    ou alta (Não use modo econômico).
                                    <br>
                                    <li>
                                        ...
                                        <br>
                                        <li>
                                            Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde
                                            se encontra o código de barras.
                                            <br>
                                            <li>
                                                Caso não apareça o código de barras no final, clique em F5 para atualizar
                                                esta tela.
                                                <li>
                                                    Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e
                                                    pague no caixa eletrônico ou no internet banking:
                                                    <br>
                                                    <br>
                                                    <span class="ld2">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;Linha Digitável: &nbsp;
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td valign=top width=268 height=1>
                            <img height=1 src=imagens/2.png width=268 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                        <td valign=top width=156 height=1>
                            <img height=1 src=imagens/2.png width=156 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=cp valign=top width=134 height=12>
                            <span class="campo">
                                <?php echo ($data_venc !="" ) ? $dadosboleto[ "data_vencimento"] :
                                "Contra Apresentação" ?>
                            </span>
                        </td>
                        <td class=cp valign=top width=7 height=12>
                    ...
                    <tr>
                        ...
                        <td valign=top width=132 height=1>
                            <img height=1 src=imagens/2.png width=132 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                        <td valign=top width=134 height=1>
                            <img height=1 src=imagens/2.png width=134 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td valign=top width=112 height=1>
                            <img height=1 src=imagens/2.png width=112 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td valign=top width=659 height=1>
                            <img height=1 src=imagens/2.png width=659 border=0>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=cp valign=top width=472 height=12>
                            PREFERENCIALMENTE NAS CASAS LOT&Eacute;RICAS AT&Eacute; O VALOR LIMITE
                        </td>
                        <td class=cp valign=top width=7 height=12>
                            <img height=12 src=imagens/1.png width=1 border=0>
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td valign=top width=133 height=1>
                            <img height=1 src=imagens/2.png width=133 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                        ...
                        <td valign=top width=102 height=1>
                            <img height=1 src=imagens/2.png width=102 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td valign=top width=43 height=1>
                            <img height=1 src=imagens/2.png width=43 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
                        <td valign=top width=103 height=1>
                            <img height=1 src=imagens/2.png width=103 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src=imagens/2.png width=7 border=0>
                        </td>
            ...
            <table cellspacing=0 cellpadding=0 border=0>
                <tbody>
                    <tr>
                        <td height=13 colspan="2" valign=top class=ct>
                            <img height=13 src=imagens/1.png width=1 border=0>
                            &nbsp; Sacado
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class=cp valign=top width=621 height=12>
                            <span class="campo">
                                 <?php echo $dadosboleto[ "sacado"]?>
                            </span>
                        </td>
            ...
            <table cellspacing=0 cellpadding=0 border=0>
                <tbody>
                    <tr>
                        ...
                        <td class=cp valign=top width=38 height=13>&nbsp;</td>
                        <td class=cp valign=top width=434><span class="campo"><?php echo $dadosboleto[ "endereco2"]?></span></td>
                        <td class=ct valign=top width=7 height=13>
                            <img height=13 src=imagens/1.png width=1 border=0>
                        </td>
                        <td class=ct valign=top width=180 height=13>
